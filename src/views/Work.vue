  ...
  <div class="work">
    ...
    <div class="work-dots">
      <span
        ...
        @click="dotSlide(item.id)"
      ></span>
    </div>

    <div class="work-carousel-wrapper">
      <div
        class="work-slide-btn work-slide-btn--prev"
        id="prev"
        title="Previous"
        @click="prevSlide()"
      >
      ...
      <div class="work-carousel-content-wrapper">
        ...
        >
          <img
            ...
            class="work-slide-img"
            :title="item.title"
          />
          <a target="_blank" :href="item.github" class="work-slide-img-link">
            <img :src="getImgUrl('github-light.png')" />see on github
          </a>
        </div>
        ...
        <div class="work-slide-content">
          ...
          <div v-if="currentContent.link" class="work-slide-title">
            <a
              class="work-slide-title"
              target="_blank"
          ...
          <div v-else class="work-slide-title">
            <a
              class="work-slide-title"
              target="_blank"
          ...
          <div class="work-slide-techs">
            <a
              v-for="tech in currentContent.tech"
              :key="tech.name"
              target="_blank"
              :href="tech.link"
            >
          ...
          <div class="work-slide-description">
            {{ currentContent.description }}
          </div>
          <div class="work-slide-links">
            <a
              target="_blank"
              class="work-slide-link"
              :href="currentContent.github"
            >
              <img
                class="work-slide-icon"
      ...
      <div
        class="work-slide-btn work-slide-btn--next"
        id="next"
        title="Next"
        @click="nextSlide()"
      >
  ...
  setup() {
    ...
    const content = [
      {
        ...
        img: "portfolio.png",
        description:
          "My introduction portfolio. A responsive single-page application built from a Node based Docker container. Complete with neon lights.",
        tech: [techIcons.vue, techIcons.sass, techIcons.ts, techIcons.docker],
        link: "",
      ...
      },
      {
        ...
        description:
          "A fully responsive online multiplayer pong platform, with a functional chat, live view, social features, 42 API authentication, 2FA, and website admin privileges. Group project, developed with docker-compose.",
        tech: [
          techIcons.vue,
          techIcons.sass,
          techIcons.ts,
      ...
      },
      {
        ...
        img: "webserv.png",
        description:
          "An HTTP 1.1 server in C++ 98, according to RFC and inspired by Nginx (GET, POST, DELETE, PUT methods). Includes requests handling, response building and file serving, customisable server configuration, and CGI execution.",
        tech: [techIcons.cpp],
        link: "",
      ...
      },
      {
        ...
        img: "sloth.png",
        description:
          "A responsive app exercise with OpenWeatherAPI and GiphyAPI. For refined passionates of both weather forecasts and glorious sloths.",
        tech: [techIcons.html, techIcons.css, techIcons.js, techIcons.webpack],
      ...
      },
      {
        ...
        img: "minirt.png",
        description:
          "A multi-threaded raytracer in C. Rendering computer-generated-images from a parsed configuration file, implementing geometry formulas.",
        tech: [techIcons.c],
        link: "",
    ...
    const nextSlide = () => {
      ...
      carousel.setAttribute(
        "style",
        "animation: rightSlideOut 1s ease forwards"
      );
      setTimeout(() => {
        ...
        carousel.setAttribute(
          "style",
          "animation: rightSlideIn 1s ease forwards"
        );
      }, 300);
    };
    ...
    const prevSlide = () => {
      ...
      carousel.setAttribute(
        "style",
        "animation: leftSlideOut 1s ease forwards"
      );
      setTimeout(() => {
        showSlide(currentSlide.value - 1);
        if (!carousel) return;
        ...
        carousel.setAttribute(
          "style",
          "animation: leftSlideIn 1s ease forwards"
        );
      }, 300);
    };
    ...
    const showSlide = (index: number) => {
      ...
      if (currentSlide.value >= SLIDES_NB) currentSlide.value = 0;
      if (currentSlide.value < 0) currentSlide.value = SLIDES_NB - 1;
