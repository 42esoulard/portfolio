<template>
  <div class="contact">
    ...
    <a
      target="_blank"
      href="https://github.com/42esoulard"
      title="GitHub: 42esoulard"
    >
      <img class="contact-gh-link" src="../assets/github-light.png" />
    </a>
    <form class="contact-form" @submit.prevent="sendMessage()">
      <label class="contact-label" for="from_name"
        ><span class="about-line">-----</span>NAME<span class="about-line"
          >-----</span
        ></label
      >
      <input
        ...
        @input="checkName()"
      />
      <label class="contact-label" for="from_email"
        ><span class="about-line">-----</span>EMAIL<span class="about-line"
          >-----</span
        ></label
      >
      <input
      ...
      <label class="contact-label" for="message"
        ><span class="about-line">-----</span>MESSAGE<span class="about-line"
          >-----</span
        ></label
      >
      <textarea
...
export default defineComponent({
  ...
  setup() {
    ...
    const checkMessage = () => {
      const msgElem: HTMLInputElement | null =
    ...
    const scrollToInvalid = () => {
      const invalidInputs: HTMLElement[] = Array.from(
